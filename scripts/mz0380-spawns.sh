...
#
# Usage
#   scripts/mz0380-spawns.sh            show the running total (no root needed)
#   sudo scripts/mz0380-spawns.sh commit    add the loaded module's spawns to it
#   sudo scripts/mz0380-spawns.sh unloaded  mark a completed rmmod boundary
#   sudo scripts/mz0380-spawns.sh add 1     repair a known missed unloaded spawn
#   sudo scripts/mz0380-spawns.sh reset     start a new power cycle at zero
#
